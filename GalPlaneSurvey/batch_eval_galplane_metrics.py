...
if len(argv) == 1:
    ...
    params['metric_groups'] = input('Please indicate which metric groups to evaluate {footprint, cadence, filter, period_color, annual, efficiency, all}: ')
else:
...
if params['metric_groups'] not in ['footprint','cadence','filter','period_color','annual', 'efficiency', 'all']:
